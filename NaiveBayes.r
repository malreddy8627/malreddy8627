...
myTerms <- c("amount", "free", "claim", "prize", "won", "draw", "latest", "win", "mobile", "txt", "text", "stop", "now", "you", "contact", "send")
...
myTerms2 = c( "free", "claim", "prize", "won", "draw", "latest", "win", "stop", "contact", "send")

sms_train2 <- DocumentTermMatrix(sms_corpus_train, list(dictionary = mywords))
sms_test2  <- DocumentTermMatrix(sms_corpus_test, list(dictionary = mywords))
